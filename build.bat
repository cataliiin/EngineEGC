...
set "INCLUDE=-I C:\msys64\ucrt64\include -I ./Engine -I ./Engine/Core -I ./Engine/Entities -I ./Engine/Entities/2D -I ./Engine/Entities/3D -I ./Engine/include -I ./Engine/src"
